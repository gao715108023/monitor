...
public final class ClientMsgProtos {
    ...
    public static final class ClientLog extends GeneratedMessage implements ClientLogOrBuilder {
        ...
        public static Parser<ClientLog> PARSER = new AbstractParser() {
            public ClientLog parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ClientLogOrBuilder {
            ...
            private void maybeForceBuilderInitialization() {
                if (ClientLog.alwaysUseFieldBuilders) {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    parsedMessage = (ClientLog) ClientLog.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
            ...
            public Builder mergeFrom(ClientLog other) {
                if (other == ClientLog.getDefaultInstance())
                    return this;
                if (other.hasKey()) {
                    setKey(other.getKey());
                }
                if (this.pcItemBuilder_ == null) {
                    ...
                    if (this.pcItemBuilder_.isEmpty()) {
                        ...
                        this.pcItem_ = other.pcItem_;
                        this.bitField0_ &= -3;
                        this.pcItemBuilder_ = (ClientLog.alwaysUseFieldBuilders ? getPcItemFieldBuilder() : null);
                    } else {
                ...
                if (this.webItemBuilder_ == null) {
                    ...
                    if (this.webItemBuilder_.isEmpty()) {
                        ...
                        this.webItem_ = other.webItem_;
                        this.bitField0_ &= -5;
                        this.webItemBuilder_ = (ClientLog.alwaysUseFieldBuilders ? getWebItemFieldBuilder() : null);
                    } else {
