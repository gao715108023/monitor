...
public class NetstatMonitor implements Runnable {
  ...
  private String[] generateCmds(Runtime runtime) {
    String totalCmd = "netstat -ant |grep ':" + Config.LISTENING_PORT + "' |wc -l";
    String establishedCmd =
        "netstat -ant |grep ':" + Config.LISTENING_PORT + "' |grep 'ESTABLISHED' |wc -l";
    String timeWaitCmd =
        "netstat -ant |grep ':" + Config.LISTENING_PORT + "' |grep 'TIME_WAIT' |wc -l";
    String finWait2Cmd =
        "netstat -ant |grep ':" + Config.LISTENING_PORT + "' | grep 'FIN_WAIT2' |wc -l";
