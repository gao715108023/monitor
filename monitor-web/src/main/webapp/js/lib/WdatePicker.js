...
(function () {
    ...
    function M($) {
        ...
        var B = $[N],
            A = ($.innerWidth) ? $.innerWidth : (B[H] && B[H].clientWidth) ? B[H].clientWidth
                : B.body.offsetWidth,
            _ = ($.innerHeight) ? $.innerHeight : (B[H] && B[H].clientHeight) ? B[H].clientHeight
                : B.body.offsetHeight;
    ...
    function b($) {
        ...
        B =
            (A && A.scrollTop != null && (A.scrollTop > _.scrollTop || A.scrollLeft > _.scrollLeft))
                ? A : _;
    ...
    function U(K, C) {
        ...
        if (C) {
            ...
            if (!L.el || L.el["My97Mark"] === true || L.el.disabled || ($dp.dd && P($dp.dd)
                                                                                  != "none"
                                                                        && $dp.dd.style.left
                                                                           != "-970px")) {
                try {
    ...
    function R(_, $) {
        return _.currentStyle ? _.currentStyle[$] : document.defaultView.getComputedStyle(_,
                                                                                          false)[$]
    }
    ...
    function I(G, _) {
        ...
        if (G.lang == "auto") {
            G.lang =
                S ? navigator.browserLanguage.toLowerCase() : navigator.language.toLowerCase();
        }
        if (!G.eCont) {
            for (var C in G) {
                $dp[C] = G[C];
        ...
        if (!$dp.dd || G.eCont || ($dp.dd && (G.getRealLang().name != $dp.dd.lang || G.skin
                                                                                     != $dp.dd.skin))) {
            if (G.eCont) {
                E(G.eCont, G);
            } else {
        ...
        function E(K, J) {
            ...
            function C() {
                ...
                for (var C = 0; C < D.length; C++) {
                    if (D[C].name == J.skin) {
                        $.push(
                            "<link rel=\"stylesheet\" type=\"text/css\" href=\"" + A + "skin/"
                            + D[C].name
