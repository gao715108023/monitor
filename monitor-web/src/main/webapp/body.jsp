...
<div class="body">
    ...
    <s:form action="data">
        ...
        <table width="60%" class="body">
            ...
            <tr>
                <th align="left" height="10px">
                    <s:textfield name="localIp" label="Ip地址(IP地址查看方式：ifconfig) "
                                 value="10.173.210.40"/>
            ...
            <tr>
                <th align="left" height="10px"><s:textfield name="begin" label="查询起始时间"
                                                            onchange="calculate('m')"
                                                            onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                                                            value="2016-12-25 09:55:03"/></th>
            </tr>
            <tr>
                <th align="left" height="10px"><s:textfield name="end" label="查询结束时间"
                                                            onchange="calculate('m')"
                                                            onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
            ...
            <tr>
                <th align="left" height="10px"><s:textfield name="processName"
                                                            label="程序的名称（可以填写任意名称）"
                                                            value="tomcat"/></th>
            </tr>
            <tr>
                <th align="left" height="10px"><s:textfield name="port" label="端口号"
                                                            value="80"/></th>
            </tr>
            <tr>
                <th align="left" height="10px"><s:submit value="查询" style="width:40px,height:40"
                                                         align="center"/></th>
            </tr>
        </table>
