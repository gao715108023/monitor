...
<div class="help">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;name="url" value="jdbc:mysql://<font
        color="red">mysql-localIp</font>:<font
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;#!/bin/sh<br/>
    &nbsp;&nbsp;&nbsp;&nbsp;ps -ef | grep -v grep | grep <font color="red">process</font> | awk
    '{print $2}'<br/>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;-t traffic Monitor the informatin of traffic. For example,
    eth0.<br/><br/>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;Posted by GaoChuanjun May 19th, 2014 <a href="http://www.gw.com.cn/"
                                                                    target="_blank">Great
    Wisdom</a>
</div>
</body>
