...
public class ServerMonitorEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (fifteenMinsProcs != null ? !fifteenMinsProcs.equals(that.fifteenMinsProcs) : that.fifteenMinsProcs != null)
            return false;
        if (fiveMinsProcs != null ? !fiveMinsProcs.equals(that.fiveMinsProcs) : that.fiveMinsProcs != null)
            return false;
        if (iowaitTime != null ? !iowaitTime.equals(that.iowaitTime) : that.iowaitTime != null) return false;
        if (ip != null ? !ip.equals(that.ip) : that.ip != null) return false;
        if (oneMinsProcs != null ? !oneMinsProcs.equals(that.oneMinsProcs) : that.oneMinsProcs != null) return false;
        if (processName != null ? !processName.equals(that.processName) : that.processName != null) return false;
        if (updateTime != null ? !updateTime.equals(that.updateTime) : that.updateTime != null) return false;
        if (usedMemory != null ? !usedMemory.equals(that.usedMemory) : that.usedMemory != null) return false;
