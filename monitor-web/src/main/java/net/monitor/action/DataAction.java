...
//            System.out.println("begin: " + begin);
    ...
    public boolean getData() {
        List<IostatMonitorEntity> iostatMonitorEntities = dbAbstract.select_iostat_monitor(ip, begin, end, diskname);
        ...
        for (IostatMonitorEntity iostatMonitorEntity : iostatMonitorEntities) {
            awaitList.add(new HighChartBean(iostatMonitorEntity.getUpdateTime().getTime(), String.valueOf(iostatMonitorEntity.getAwait())));
            svctmList.add(new HighChartBean(iostatMonitorEntity.getUpdateTime().getTime(), String.valueOf(iostatMonitorEntity.getSvctm())));
            utillist.add(new HighChartBean(iostatMonitorEntity.getUpdateTime().getTime(), String.valueOf(iostatMonitorEntity.getUtil())));
        }
...
//        return packData(awaitList);
    ...
    public boolean getServerMonitorData() {
        List<ServerMonitorEntity> serverMonitorEntityList = dbAbstract.select_server_monitor(ip, begin, end, processId);
        ...
        for (ServerMonitorEntity serverMonitorEntity : serverMonitorEntityList) {
            cpuList.add(new HighChartBean(serverMonitorEntity.getUpdateTime().getTime(), String.valueOf(serverMonitorEntity.getCpuUsage())));
            memList.add(new HighChartBean(serverMonitorEntity.getUpdateTime().getTime(), String.valueOf(serverMonitorEntity.getUsedMemory())));
            oneMinsProcsList.add(new HighChartBean(serverMonitorEntity.getUpdateTime().getTime(), String.valueOf(serverMonitorEntity.getOneMinsProcs())));
            fiveMinsProcsList.add(new HighChartBean(serverMonitorEntity.getUpdateTime().getTime(), String.valueOf(serverMonitorEntity.getFiveMinsProcs())));
            fifteenMinsProcsList.add(new HighChartBean(serverMonitorEntity.getUpdateTime().getTime(), String.valueOf(serverMonitorEntity.getFifteenMinsProcs())));
        }
    ...
    public boolean getTrafficMonitorData() {
        List<TrafficMonitorEntity> trafficMonitorEntityList = dbAbstract.select_traffic_monitor(ip, begin, end);
        ...
        for (TrafficMonitorEntity trafficMonitorEntity : trafficMonitorEntityList) {
            receiveTrafficList.add(new HighChartBean(trafficMonitorEntity.getUpdateTime().getTime(), String.valueOf(trafficMonitorEntity.getReceiveTraffic() / Constant.UNITS)));
            transmitTrafficList.add(new HighChartBean(trafficMonitorEntity.getUpdateTime().getTime(), String.valueOf(trafficMonitorEntity.getTransmitTraffic() / Constant.UNITS)));
        }
    ...
    public boolean getNetstatMonitorData() {
        List<NetstatMonitorEntity> netstatMonitorEntityList = dbAbstract.select_netstat_monitor(ip, begin, end, port);
        ...
        for (NetstatMonitorEntity netstatMonitorEntity : netstatMonitorEntityList) {
            totalList.add(new HighChartBean(netstatMonitorEntity.getUpdateTime().getTime(), String.valueOf(netstatMonitorEntity.getTotal())));
            establishedList.add(new HighChartBean(netstatMonitorEntity.getUpdateTime().getTime(), String.valueOf(netstatMonitorEntity.getEstablished())));
            timeWaitList.add(new HighChartBean(netstatMonitorEntity.getUpdateTime().getTime(), String.valueOf(netstatMonitorEntity.getTimeWait())));
            finWait2List.add(new HighChartBean(netstatMonitorEntity.getUpdateTime().getTime(), String.valueOf(netstatMonitorEntity.getFinWait2())));
        }
    ...
    public boolean getComputeNodeStatus() {
        ...
        List<ComputeNodeStatusEntity> computeNodeStatusEntityList = dbAbstract.select_compute_node_status(ip, begin, end);
        List<HighChartBean> oneMinsProcsList = new ArrayList<HighChartBean>();
        List<HighChartBean> fiveMinsProcsList = new ArrayList<HighChartBean>();
        List<HighChartBean> fifteenMinsProcsList = new ArrayList<HighChartBean>();
        ...
        for (ComputeNodeStatusEntity computeNodeStatusEntity : computeNodeStatusEntityList) {
            ...
            oneMinsProcsList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getOneMinsProcs())));
            fiveMinsProcsList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getFiveMinsProcs())));
            fifteenMinsProcsList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getFifteenMinsProcs())));

            totalTimeList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getTotalTime())));
            userTimeList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getUserTime())));
            niceTimeList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getNiceTime())));
            systemTimeList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getSystemTime())));
            iowaitTimeList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getIowaitTime())));
            idleTimeList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getIdleTime())));

            totalMemoryList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getTotalMemory())));
            usedMemoryList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getUsedMemory())));
            idleMemoryList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getIdleMemory())));
            swapSizeList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getSwapSize())));
            usedSwapList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getUsedSwap())));
            idleSwapList.add(new HighChartBean(computeNodeStatusEntity.getUpdateTime().getTime(), String.valueOf(computeNodeStatusEntity.getIdleSwap())));
        }
        setOneMinsProcs(packData(oneMinsProcsList));
        setFiveMinsProcs(packData(fiveMinsProcsList));
        setFifteenMinsProcs(packData(fifteenMinsProcsList));
    ...
    private String packData(List<HighChartBean> highChartBeans) {
        ...
        for (HighChartBean highChartBean : highChartBeans) {
            sb.append("[").append(highChartBean.getUpdateTime()).append(",").append(highChartBean.getValue()).append("]").append(",");
        }
