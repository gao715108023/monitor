...
public class DBCommon extends DBAbstract {
    ...
    public List<IostatMonitorEntity> select_iostat_monitor(String ip, String begin, String end, String diskname) {
        ...
        try {
            ...
            final Query query = session.createQuery("from " + entityName + " where ip = '" + ip + "' and updateTime >= '" + begin + "' and updateTime < '" + end + "' and name = '" + diskname + "'");
...
//            }
    ...
    public List<ServerMonitorEntity> select_server_monitor(String ip, String begin, String end, String processId) {
        ...
        try {
            ...
            final Query query = session.createQuery("from " + entityName + " where ip = '" + ip + "' and updateTime >= '" + begin + "' and updateTime < '" + end + "' and processId = " + processId + "");
            System.out.println("executing: " + query.getQueryString());
    ...
    public List<TrafficMonitorEntity> select_traffic_monitor(String ip, String begin, String end) {
        ...
        try {
            ...
            final Query query = session.createQuery("from " + entityName + " where ip = '" + ip + "' and updateTime >= '" + begin + "' and updateTime < '" + end + "'");
            System.out.println("executing: " + query.getQueryString());
    ...
    public List<NetstatMonitorEntity> select_netstat_monitor(String ip, String begin, String end, String port) {
        ...
        try {
            ...
            final Query query = session.createQuery("from " + entityName + " where ip = '" + ip + "' and updateTime >= '" + begin + "' and updateTime < '" + end + "' and port = " + port + "");
            System.out.println("executing: " + query.getQueryString());
